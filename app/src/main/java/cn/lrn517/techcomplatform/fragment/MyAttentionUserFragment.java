...
public class MyAttentionUserFragment extends Fragment {
    ...
    public MyAttentionUserFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_my_attention_user, container, false);
    ...
    private void initView(View view){
        recyclerView = view.findViewById(R.id.my_attention_user_recyclerview);
        linearLayoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(linearLayoutManager);
    }

    private void initEvent(){
        call = userModel.getAttentionDataList(11,uid);
        Callback<List<commonAttentionData>> callback = new Callback<List<commonAttentionData>>() {
            ...
            public void onResponse(Call<List<commonAttentionData>> call, Response<List<commonAttentionData>> response) {
                ...
                if( 0 != data.size()){
                    myAttentionCommonViewAdapter = new MyAttentionCommonViewAdapter(getActivity() , data , 11);
