...
public class tpzFirstComment {
    ...
    public String getTpzcid() {
        return tpzcid;
    }

    public void setTpzcid(String tpzcid) {
        this.tpzcid = tpzcid;
    }
    ...
    public String getTpzctime() {
        return tpzctime;
    }

    public void setTpzctime(String tpzctime) {
        this.tpzctime = tpzctime;
    }
}
